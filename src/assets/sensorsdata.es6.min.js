      ...
      p = (_.each = function (e, t, r) {
        ...
        if (c && e.forEach === c) e.forEach(t, r);
          ...
          for (var s = 0, a = e.length; s < a; s++)
            if (s in e && t.call(r, e[s], s, e) === l) return !1;
        } else
          for (var i in e)
            if (d.call(e, i) && t.call(r, e[i], i, e) === l) return !1;
      });
    (_.map = function (e, t) {
      var r = [];
      return null == e
        ...
        verifyVtrackMode: function () {
          window.addEventListener &&
            ...
            window.parent &&
              ...
              window.parent.postMessage(
                { source: "sa-web-sdk", type: "v-is-vtrack", data: {} },
                "*"
              );
        },
      },
    ...
    e.isSeachHasKeyword()
      ...
      ? (t.verifyVtrackMode(),
        setTimeout(function () {
          ...
          t.removeMessageHandle(),
            e.isStoregeHasKeyword() ? e.storageHasKeywordHandle() : s();
        }, 1e3))
      : s();
  }),
  (BatchSend.prototype = {
    ...
    send: function (e) {
      var t = this,
        r = _.isArray(sd.para.server_url)
...
(sd.sendState = sendState),
  ...
  (sendState.sendCall = function (e, t) {
    ...
    "function" == typeof sd.para.jsapp.setData
      ? (delete r.callback, (r = JSON.stringify(r)), sd.para.jsapp.setData(r))
      ...
      if (
        ...
        sd.bridge.is_verify_success
          ? (SensorsData_APP_New_H5_Bridge.sensorsdata_track(
              JSON.stringify(_.extend({ server_url: sd.para.server_url }, e))
            ),
            "function" == typeof r && r())
          : sd.para.app_js_bridge.is_send
...
var heatmap = (sd.heatmap = {
  ...
  selector: function (e) {
    ...
    return e.getAttribute &&
      ...
      ? "#" + e.getAttribute("id")
      : e.tagName.toLowerCase() + (~t ? ":nth-of-type(" + (t + 1) + ")" : "");
  },
      ...
      addListen: function () {
        ...
        e._.addEvent(document, "mousedown", function (t) {
          ...
          if ("a" === r.tagName.toLowerCase() && r.href) {
            ...
            ("http:" !== s && "https:" !== s) ||
              (e.getPart(r.href) && e.rewireteUrl(r.href, r));
          }
        });
      },
      init: function (e, t) {
